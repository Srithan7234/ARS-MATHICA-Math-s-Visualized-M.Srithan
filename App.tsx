      ...
      <aside className="w-[100px] bg-black border-r border-white/10 flex flex-col items-center py-6 gap-2 shrink-0 z-50 shadow-2xl">
          ...
          <div className="mt-auto w-full flex flex-col items-center gap-2">
            <button
              ...
              className="w-full flex flex-col items-center justify-center gap-2 p-3 transition-all relative group text-gray-500 hover:text-gray-300"
            >
              <div className="p-3 rounded-xl transition-all group-hover:bg-white/5">
                <Globe size={24} strokeWidth={1.5} />
              </div>
              <span className="text-[9px] font-bold text-center leading-none tracking-wide">Applications</span>
            </button>
