...
const NavItem = ({ icon: Icon, label, id, activeTab, setActiveTab }: { icon: any, label: string, id: string, activeTab: string, setActiveTab: (id: string) => void }) => (
    <button
    ...
    return (
        <div className="flex h-screen bg-black text-gray-300 font-sans selection:bg-purple-500/30 selection:text-white overflow-hidden relative">
            ...
            <aside className="w-[100px] bg-black border-r border-white/10 flex flex-col items-center py-6 gap-2 shrink-0 z-50 shadow-2xl">
                ...
                <NavItem icon={Sparkles} label="FRACTAL EXPLORER" id="EXPLORER" activeTab={activeTab} setActiveTab={setActiveTab} />
                <NavItem icon={Atom} label="ALGORITHMIC ART" id="ART" activeTab={activeTab} setActiveTab={setActiveTab} />
                <NavItem icon={Brain} label="DETECT & PAINT" id="DETECT" activeTab={activeTab} setActiveTab={setActiveTab} />
                <NavItem icon={ImageIcon} label="COMMUNITY" id="COMMUNITY" activeTab={activeTab} setActiveTab={setActiveTab} />

                <div className="mt-auto w-full flex flex-col items-center gap-2">
                    <div className="w-12 h-[1px] bg-white/5 my-2"></div>
                    <NavItem icon={SettingsIcon} label="SETTINGS" id="SETTINGS" activeTab={activeTab} setActiveTab={setActiveTab} />
                </div>
            </aside>
